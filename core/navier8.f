...
c           call assign_gllnid(gllnid,gllel,nelgt,nelgv,np) ! gllel is used as scratch
            ...
            else if (distrib .eq. 3) then !load balance version 2
                call recompute_partitions_vers2_cen
            else if (distrib .eq. 4) then !load balance version 2
                call recompute_partitions_vers2_dist
            else if (distrib .eq. 5) then !load balance version 2
                call recompute_partitions_vers2_hybrid
            endif
            lng = isize*neli
